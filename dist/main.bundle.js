    ...
    */
    ...
    RecipeEditorComponent.prototype.save = function () {
        ...
        var p = new Promise(function (resolve, reject) {
            ...
            else if ((__WEBPACK_IMPORTED_MODULE_6_jquery__('#image')[0].files[0] == null && _this.recipe.id == null) || _this.recipe.title == null || _this.recipe.preparation == null) {
                resolve('default.jpg');
            }
            else if (__WEBPACK_IMPORTED_MODULE_6_jquery__('#image')[0].files[0] == null && _this.recipe.id != null) {
                resolve(_this.recipe.pictureURL);
            }
            else {
...
var SignupComponent = /** @class */ (function () {
    ...
    SignupComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__user_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* Router */]])
    ], SignupComponent);
